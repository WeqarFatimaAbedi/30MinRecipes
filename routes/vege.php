...
<head>
    ...
    <title>Vegetarian - 30MinRecipes</title>
...
<body>
    ...
    <div class="container-fluid">
        ...
        <div id="getRecipes"></div>      <!--ID=GETRECIPES-->
        <hr>
    ...
    function getRecipes(){
        $.ajax({
            ...
            success : function(data){
                console.log(data);
                var recipes = data;      //assign the response to recipe variable
                var getRecipes = '';
                            ...
                            '<div class="col-md-4 form-group text-center py-3">'+
                                    '<form>'+
                                      ...
                                      //recipe title is displayed
                                        ...
                                        //image is displayed and uploaded in the uploads folder
                                        '<div class="form-row">'+
                                            '<div class="form-group col-md-12">'+
