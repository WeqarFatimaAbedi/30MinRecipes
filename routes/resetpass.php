  ...
  <div class="container-fluid p-0" >
     <article class="mx-auto" style="max-width: 400px;">
        ...
        <h1 class="mt-3 text-center">Reset Password</h1>
          <p class="text-center">Please enter your new passwords</p>
       ...
       <form>  
        <div class="form-group input-group">
           ...
           <input type="password" id="pass" placeholder="New Password" class="form-control" value="" required autocomplete="off" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters">
         </div>
         <div class="form-group input-group">
           <div class="input-group-prepend">
             <span class="input-group-text">
           ...
           <input type="password" id="cpass" placeholder="Confirm Password" class="form-control" value="" required autocomplete="off">
         </div>
