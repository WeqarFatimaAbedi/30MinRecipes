      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          <li class="nav-item profile">
            <div class="profile-desc">
              ...
              <div class="dropdown-menu dropdown-menu-right sidebar-dropdown preview-list" aria-labelledby="profile-dropdown">
                ...
                <a href="admin_reg.php" class="dropdown-item preview-item">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="newdashboard.php">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="#">
              ...
              <span class="menu-title">Insert recipes</span>
            </a>
          </li>
         ...
         <!--  <li class="nav-item menu-items">
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="auth">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="pages/samples/blank-page.html"> Subscribed users</a></li>
